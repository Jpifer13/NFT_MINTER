...
const contract = require("../artifacts/contracts/nft_00.sol/TestNFT.json");
const contractAddress = "0x029435D665c14B19bB27a32DadDC7eE5c1bB5Dfb"
...
async function mintNFT(tokenURI) {
  ...
  const tx = {
    ...
    data: nftContract.methods
      .createNFT("0xA81c4C888C4F89E97d4B3224dd4aE8d646f1E332", tokenURI) // account 2, tokenURI
...
mintNFT("https://ipfs.io/ipfs/QmVmhXiUwH42GQbnQnuVstBpHSJRGZHeFQgRiaD7Szy2DD") // pass the CID to the JSON file uploaded to Pinata
