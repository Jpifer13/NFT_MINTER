...
contract TestNFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter; // using for attaches library functions from Counters to Counters.Counter
    Counters.Counter private _tokenIds;

    // the name and symbol for the NFT
    constructor() ERC721("NFT_00", "TNFT") {}
   ...
   // receiver takes a type of address. This is the wallet address of the user that should receive the NFT minted using the smart contract
    ...
    // string memory says to store tokenURI in memory vs storage
